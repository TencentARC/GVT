...
def set_schedule(pl_module):
    ...
    if 'tuning' in pl_module.hparams.config['exp_name']:
        print("setting constant lr scheduler")
        scheduler = get_polynomial_decay_schedule_with_warmup(
            optimizer, num_warmup_steps=0, num_training_steps=int(1e10),
            lr_end=(lr-1e-8), power=1.0
        )
